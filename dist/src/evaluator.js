...
function evalInfixExpression(operator, left, right) {
    if (left instanceof object_1.Integer && right instanceof object_1.Integer) {
        return evalIntegerInfixExpression(operator, left, right);
    }
    if (left instanceof object_1.StringObj && right instanceof object_1.StringObj) {
        if (operator === "+")
            return new object_1.StringObj(left.value + right.value);
        if (operator === "==")
