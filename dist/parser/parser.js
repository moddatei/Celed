...
(function (Precedence) {
    ...
    Precedence[Precedence["ARROW"] = 4] = "ARROW";
    Precedence[Precedence["PIPE"] = 5] = "PIPE";
    Precedence[Precedence["EQUALS"] = 6] = "EQUALS";
    Precedence[Precedence["LESSGREATER"] = 7] = "LESSGREATER";
    Precedence[Precedence["SUM"] = 8] = "SUM";
    Precedence[Precedence["PRODUCT"] = 9] = "PRODUCT";
    Precedence[Precedence["CALL"] = 10] = "CALL";
    Precedence[Precedence["INDEX"] = 11] = "INDEX";
...
const precedences = {
    ...
    [token_1.TokenType.NOT_EQ]: Precedence.EQUALS,
...
class Parser {
    constructor(lexer) {
        ...
        this.registerPrefix(token_1.TokenType.WHILE, this.parseWhileExpression.bind(this));
        ...
        this.registerInfix(token_1.TokenType.MOD, this.parseInfixExpression.bind(this));
        this.registerInfix(token_1.TokenType.EQUALS, this.parseInfixExpression.bind(this));
        this.registerInfix(token_1.TokenType.NOT_EQ, this.parseInfixExpression.bind(this));
        this.registerInfix(token_1.TokenType.LT, this.parseInfixExpression.bind(this));
        this.registerInfix(token_1.TokenType.GT, this.parseInfixExpression.bind(this));
        this.registerInfix(token_1.TokenType.LTE, this.parseInfixExpression.bind(this));
        this.registerInfix(token_1.TokenType.GTE, this.parseInfixExpression.bind(this));
        this.registerInfix(token_1.TokenType.AND, this.parseInfixExpression.bind(this));
        this.registerInfix(token_1.TokenType.OR, this.parseInfixExpression.bind(this));
        ...
        this.registerInfix(token_1.TokenType.DOT, this.parseDotExpression.bind(this));
    ...
    parseWhileExpression() {
        ...
        return new ast_1.WhileExpression(token, condition, body);
    }
    parseArrayLiteral() {
    ...
    parseIndexExpression(left) {
        ...
        return new ast_1.IndexExpression(token, left, index);
    }
    parseDotExpression(left) {
        const token = this.curToken;
        this.nextToken(); // consume DOT
        if (this.curToken.type !== token_1.TokenType.IDENTIFIER) {
            this.errors.push(`expected IDENTIFIER after DOT, got ${this.curToken.type}`);
            return null;
        }
        const rightToken = Object.assign(Object.assign({}, this.curToken), { type: token_1.TokenType.STRING });
        const right = new ast_1.StringLiteral(rightToken, rightToken.literal);
        return new ast_1.IndexExpression(token, left, right);
    }
    parseHashLiteral() {
